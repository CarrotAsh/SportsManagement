...
public class SettingsDefault {
    public static void loadData(){
        ...
        OptionsMenu.players.add(new Player("alvaro@alumnos.upm.es", "12345", "Alvaro", "Rojo", "10234765A", 12, 15, 4, 10, 1000));
        OptionsMenu.players.add(new Player("adrian@alumnos.upm.es", "12345", "Adrian", "Perez", "50234765B", 8, 12, 5, 5, 500));
        OptionsMenu.players.add(new Player("ines@alumnos.upm.es", "12345", "Ines", "Gomez", "30234765C", 10, 10, 2, 5, 570));
        OptionsMenu.players.add(new Player("fran@alumnos.upm.es", "12345", "Fran", "Vallejo", "70234765C", 9, 8, 1, 4, 450));
        OptionsMenu.players.add(new Player("javier@alumnos.upm.es", "12345", "Javier", "Gonzalez", "70234765C", 7, 5, 1, 4, 350));
        OptionsMenu.players.add(new Player("carlos@alumnos.upm.es", "12345", "Carlos", "Carvajal", "70234765C", 11, 9, 7, 3, 750));

        OptionsMenu.teams.add(new Team("IWSIM21"));
        OptionsMenu.teams.add(new Team("IWSIM22"));
        OptionsMenu.teams.add(new Team("CITIM21"));
        OptionsMenu.teams.add(new Team("CITIT21"));
        ...
        Tournament tournamentF = new Tournament("TorneoFutbol", LocalDate.parse("22/12/2024", format), LocalDate.parse("24/12/2024", format), "Liga Mayor", "Futbol", "score");
        ...
        Tournament tournamentB = new Tournament("TorneoBaloncesto", LocalDate.parse("28/12/2024", format), LocalDate.parse("30/12/2024", format), "Liga Menor", "Baloncesto", "winMatch");
